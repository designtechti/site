<ul class="listaProdutos">
	<?php require('../../admin/includes/conexao.php'); var_dump($conexão) ?>
	...
	<?php	
		...
		if (!empty($_POST['pesquisa'])) {
			...
			$sql = "SELECT * FROM loja WHERE titulo LIKE '%$pesquisa%' ORDER BY titulo";
			$result = mysqli_query($conexao, $sql);

		}else {
			$sql = "SELECT * FROM loja ORDER BY titulo";
			$result = mysqli_query($conexao, $sql);
		}
